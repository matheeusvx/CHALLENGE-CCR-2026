...
The legacy `tile_v1` strategy maps the validated viewport center to a Web Mercator
...
The default `AUTO_ANALYSIS_SPATIAL_STRATEGY=roadside_v1` enables the first
...
`tile_v1` remains available only as an explicit legacy strategy.
